...
public class GluListActivity extends CarpActivity {
	...
	private void initEvents() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int index,
				...
				bundle.putString("glu", mCursor.getString(1));
				bundle.putString("result", mCursor.getString(2));
				bundle.putString("date", mCursor.getString(3));
				bundle.putString("time", mCursor.getString(4));
				Intent i = new Intent(GluListActivity.this, GluActivity.class);
		...
		mNewRecordButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				Intent i = new Intent();
				i.setClass(GluListActivity.this, GluActivity.class);
				startActivityForResult(i, 1);
			}
		});
	}
